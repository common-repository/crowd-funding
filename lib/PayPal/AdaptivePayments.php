...
class AdaptivePayments extends Paypal_CallerServices
{
    function Pay($payRequest, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in Pay method');
        }
    ...
    function PaymentDetails($paymentDetailsRequest, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in PaymentDetails method');
        }
    }
    ...
    function Preapproval($preapprovalRequest, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in Preapproval method');
        }
    ...
    function PreapprovalDetails($preapprovalDetailsRequest, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in PreapprovalDetails method');
        }
    ...
    function CancelPreapproval($cancelPreapprovalRequest, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in CancelPreapproval method');
        }
    ...
    function Refund($refundRequest, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in Refund method');
        }
    ...
    function ConvertCurrency($convertCurrencyRequest, $SerializeOption = null, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in ConvertCurrency method');
        }
    ...
    function GetFundingPlans($GetFundingPlansRequest, $SerializeOption = null, $isRequestString = false)
    {
        try {
            ...
            throw new PaypalFatalException('Error occurred in GetFundingPlans method');
        }
    }
    ...
    private function callAPI($request, $URL, $SerializeOption = null)
    {
        ...
        try {
            ...
            throw new PaypalFatalException('Error occurred in callAPI method');
        }
